...
output: 
  html_document:
    ...
    theme: sandstone
---
Hi, this is Yunshen Bai. In this part, we will use NYC Restaurant Inspections dataset, and use different kind of plot to show the pattern in this dataset.
...
Finally, we want to know the relationship between building and score.
```{r}
